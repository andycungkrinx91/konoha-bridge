...
// Exposes Antigravity as a local OpenAI-compatible HTTP API on localhost:1313
//
// Architecture:
//   HTTP server (:1313) → discovers sidecar process → calls sidecar ConnectRPC → returns OpenAI response
//
