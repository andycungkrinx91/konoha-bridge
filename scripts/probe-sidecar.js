...
const SIDECAR_BINARY_NAMES = {
    ...
    darwin: ['language_server_macos_arm', 'language_server_macos_x64', 'language_server_macos_arm64', 'language_server_macos'],
...
async function discoverSidecar() {
    ...
    if (!binaryNames) throw new Error(`Unsupported platform: ${platform}`);
    ...
    if (platform === 'win32') {
        ...
        const line = stdout.split('\n').find((l) => binaryNames.some((b) => l.includes(b)) && !l.includes('grep'));
